...
import com.example.wordgame.model.Student;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnOK.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(sts){
                    Toast.makeText(DatabaseActivity.this, "Student Added Successfully!", Toast.LENGTH_SHORT).show();
        ...
        btnDisplay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DatabaseActivity.this, DisplayStudentActivity.class);
